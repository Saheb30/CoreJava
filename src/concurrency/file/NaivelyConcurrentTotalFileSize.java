...
public class NaivelyConcurrentTotalFileSize {
	...
	public static void main(final String[] args) throws InterruptedException, ExecutionException, TimeoutException {
		...
		//final long total = new NaivelyConcurrentTotalFileSize().getTotalSizeOfFile("C:\\Windows\\System32\\drivers\\etc");
		final long total = new NaivelyConcurrentTotalFileSize().getTotalSizeOfFile("C:\\Users");
